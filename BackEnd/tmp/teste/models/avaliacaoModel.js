...
], Avaliacao.prototype, "idAvaliacao", void 0);
__decorate([
    sequelize_typescript_1.Column(sequelize_typescript_1.DataType.INTEGER),
    __metadata("design:type", Number)
], Avaliacao.prototype, "idCartao", void 0);
__decorate([
    sequelize_typescript_1.Column(sequelize_typescript_1.DataType.TINYINT),
    __metadata("design:type", Number)
], Avaliacao.prototype, "idCaixa", void 0);
__decorate([
    sequelize_typescript_1.Column(sequelize_typescript_1.DataType.INTEGER),
    __metadata("design:type", Number)
], Avaliacao.prototype, "idTipoAvaliacao", void 0);
__decorate([
    sequelize_typescript_1.Column(sequelize_typescript_1.DataType.DATE),
    __metadata("design:type", Date)
], Avaliacao.prototype, "dtaProximaAvaliacao", void 0);
Avaliacao = __decorate([
    sequelize_typescript_1.Table({ tableName: 'Avaliacao', timestamps: false })
], Avaliacao);
